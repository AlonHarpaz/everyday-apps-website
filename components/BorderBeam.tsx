...
interface BorderBeamProps {
  ...
  colorTo?: string;
  delay?: number;
  cycleDuration?: number; // Total cycle duration for all beams
}
      ...
      style={
        {
          ...
          "--color-to": colorTo,
          "--delay": `-${delay}s`,
          "--cycle-duration": cycleDuration ? `${cycleDuration}s` : undefined,
          "--fade-delay": `${delay}s`,
          opacity: cycleDuration ? 0 : undefined,
          animation: cycleDuration
            ? `border-beam-fade ${cycleDuration}s linear ${delay}s infinite`
            : undefined,
